...
@alink(['can'=>'admin', 'icon'=>'fas fa-list', 'title'=>'Каталог запчастей'])
    @alink(['can'=>'admin', 'url'=>route('admin.groups.main'), 'icon'=>'fas fa-layer-group', 'title'=>'Группы'])@endalink
    @alink(['can'=>'admin', 'url'=>route('admin.part_catalogs.main'), 'icon'=>'fas fa-list', 'title'=>'Категории'])@endalink
    @alink(['can'=>'admin', 'url'=>route('admin.parts.main'), 'icon'=>'fas fa-car-battery', 'title'=>'Запчасти'])@endalink
...
@alink(['can'=>'admin', 'url'=>route('admin.brands.main'), 'icon'=>'fas fa-list-ol', 'title'=>'Бренды'])@endalink
@alink(['can'=>'admin', 'url'=>route('admin.partner_groups.main'), 'icon'=>'fas fa-handshake', 'title'=>'Группы партнеров'])@endalink
...
@alink(['can'=>'content', 'icon'=>'fas fa-sitemap', 'title'=>'Справочник'])
    ...
    @alink(['can'=>'admin', 'url'=>route('admin.banners', ['page'=>'info']), 'icon'=>'fas fa-info-circle', 'title'=>'Информация']) @endalink
    @alink(['can'=>'admin', 'url'=>route('admin.banners', ['page'=>'images']), 'icon'=>'fas fa-file-image', 'title'=>'Основные изоброжения'])@endalink
    @alink(['can'=>'admin', 'url'=>route('admin.news.main'), 'icon'=>'far fa-newspaper', 'title'=>'Новости'])@endalink
    @alink(['can'=>'admin', 'url'=>route('admin.home_slider.main'), 'icon'=>'mdi mdi-play-box-outline', 'title'=>'Главный слайдер'])@endalink
    @alink(['can'=>'admin', 'url'=>route('admin.delivery_regions.main'), 'icon'=>'fas fa-globe-europe', 'title'=>'Регионы доставки'])@endalink
    @alink(['can'=>'admin', 'icon'=>'fas fa-columns', 'title'=>'Блоки стат. страниц'])
        @alink(['can'=>'admin', 'url'=>route('admin.banners', ['page'=>'auth']), 'icon'=>'fas fa-key', 'title'=>'Вход/Регистрация'])@endalink
        @alink(['can'=>'admin', 'url'=>route('admin.banners', ['page'=>'texts']), 'icon'=>'fas fa-list', 'title'=>'Другие тексты'])@endalink
    @endalink
@endalink
