...
@section('content')
<form action="{!! $edit?route('admin.pickup_points.edit', ['id'=>$item->id]):route('admin.pickup_points.add') !!}" method="post">
    ...
    <div class="row">
        <div class="col-12 col-lg-6">
            <div class="card">
                ...
                <div class="little-p">
                    <input type="text" name="address" class="form-control" placeholder="Адрес" maxlength="255" value="{{ old('address', $item->address??null) }}">
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6">
            ...
            <div class="card">
                <div class="little-p">
                    ...
                    <div class="mt-2" style="max-width: 300px">
                        <input type="text" name="lat" class="form-control map-inp lat" placeholder="Широта" maxlength="20" value="{{ old('lat', $item->lat??null) }}">
                        <input type="text" name="lng" class="form-control map-inp lng mt-2" placeholder="Долгота" maxlength="20" value="{{ old('lng', $item->lng??null) }}">
