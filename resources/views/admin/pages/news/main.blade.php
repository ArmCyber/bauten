...
@section('content')
                    ...
                    @foreach($items as $item)
                        <tr class="item-row" data-id="{!! $item->id !!}">
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.gallery', ['gallery'=>'news_item', 'id'=>$item->id]) }}" {!! tooltip('Галерея') !!} class="icon-btn gallery"></a>
    ...
    <p class="font-14">Вы действительно хотите удалить новость &Lt;<span id="pdm-title"></span>&Gt;?</p>
    @endmodal
@endsection
@push('css')
