...
@section('titleSuffix')| <a href="{!! route('admin.criteria.add', ['id'=>$filter->id]) !!}" class="text-cyan"><i class="mdi mdi-plus-box"></i> добавить</a>@endsection
@section('content')
    @if(count($items))
        <div class="card">
    ...
    <script>
        ...
        $('#itemDeleteForm').on('submit', function(){
            ...
            if (thisItemId && thisItemId.match(/^[1-9][0-9]{0,9}$/)) {
                ...
                $.ajax({
                    url: '{!! route('admin.criteria.delete') !!}',
                    type: 'post',
                    dataType: 'json',
                    data: {
                        _token: csrf,
