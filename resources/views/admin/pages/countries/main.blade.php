...
@section('titleSuffix')| <a href="{!! route('admin.countries.add') !!}" class="text-cyan"><i class="mdi mdi-plus-box"></i> добавить</a>@endsection
@section('content')
    @if(count($items))
        <div class="card">
            <div class="table-responsive p-2">
                <table class="table table-striped m-b-0 columns-middle init-dataTable">
                    ...
                    <tbody class="table-sortable" data-action="{!! route('admin.countries.sort') !!}">
