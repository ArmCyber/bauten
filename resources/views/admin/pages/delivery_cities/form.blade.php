...
@section('content')
<form action="{!! $edit?route('admin.delivery_cities.edit', ['id'=>$item->id]):route('admin.delivery_cities.add', ['id'=>$region->id]) !!}" method="post">
    ...
    <div class="row">
        <div class="col-12 col-lg-6">
            ...
            <div class="card">
                ...
                <div class="little-p">
                    <input type="text" name="price" class="form-control" placeholder="Цена доставки" value="{{ old('price', $item->price??null) }}">
                </div>
            </div>
        </div>
    </div>
